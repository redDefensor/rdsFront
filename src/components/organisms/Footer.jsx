    ...
    <footer className='bg-gray-950 border-t border-gray-800 text-light mt-4 py-4 flex flex-col justify-center items-center'>
      <section className='max-w-[1200px] w-3/4 border-b border-gray-800 grid grid-cols-3 gap-4 pb-4'>
        <section className='flex flex-col gap-4'>
          <h3 className='text-primary font-bold text-lg'>Sobre nosotros</h3>
          <img src={logo} alt='logo' />
          <p className='text-light opacity-50'>En RDS nos comprometemos a brindarte la mejor experiencia en servicios de alquilar y vender vehículos. Con años de experiencia en el mercado, somos líderes en la industria automotriz, ofreciendo soluciones innovadoras y personalizadas para satisfacer tus necesidades.</p>
        </section>
        <section className='flex flex-col items-center'>
          <h3 className='text-center mb-4'>Contáctanos</h3>
          <ul className='w-1/2 grid grid-cols-2 gap-4 place-items-center'>
            <li className='w-[40px] h-[40px] text-light hover:text-primary cursor-pointer'>
              <a href='#' target='_blank' rel='noopener noreferrer'>
                <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><title>X</title><path fill='currentColor' d='M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z' /></svg>
              </a>
            </li>
            <li className='w-[40px] h-[40px] text-light hover:text-primary cursor-pointer'>
              <a href='#'>
      ...
      <section className='max-w-[1200px] w-3/4 mt-4 flex justify-between items-center font-light opacity-50'>
        <p>© {new Date().getFullYear()} RDS. Todos los derechos reservados.</p>
        <span>Desarrollado por <a href='https://github.com/samAlcazar' target='_blank' rel='noopener noreferrer' className='text-[#34b7f1] font-light hover:opacity-80 transition-all duration-300'>saalcazar</a></span>
      </section>
    </footer>
  )
}
